...
def print_results(results_dic, results_stats_dic, model,
    ...
    Parameters:
      # ... (parameters as in your docstring)
...
#
    ...
    print("Number of Not a dog:",results_stats_dic['n_notdogs_img'])
    ...
    if(print_incorrect_dogs):
            ...
            for key, lst in results_dic.items():
                    if(lst[3]+lst[4]==1):
                            print('              ',key)
                            print("Pet Label Dog:", lst[0], "           Classifier Label Dog:",lst[1])
                            
    for i in range(3):
            print()
    if(print_incorrect_breed):
            print("Printing Incorrectly classified breeds")
            for key, lst in results_dic.items():
                    if(lst[2]==0):
                            print('              ',key)
                            print("Real Label:", lst[0], "           Classifier label:",lst[1])
